...
CREATE TABLE XRefUserMetricAlarm (
	...
	FOREIGN KEY (MetricAlarmId) REFERENCES MetricAlarms(MetricAlarmId) ON UPDATE CASCADE ON DELETE CASCADE,
...
CREATE TABLE XRefLogAlarmLogGroup (
	...
	FOREIGN KEY (LogAlarmId) REFERENCES LogAlarms(LogAlarmId) ON UPDATE CASCADE ON DELETE CASCADE,
	FOREIGN KEY (LogGroupId) REFERENCES LogGroups(LogGroupId) ON UPDATE CASCADE ON DELETE CASCADE,
...
CREATE TABLE XRefLogAlarmKeyword (
	...
	FOREIGN KEY (LogAlarmId) REFERENCES LogAlarms(LogAlarmId) ON UPDATE CASCADE ON DELETE CASCADE,
	FOREIGN KEY (KeywordId) REFERENCES Keywords(KeywordId) ON UPDATE CASCADE ON DELETE CASCADE,
...
CREATE TABLE XRefLogAlarmSNSTopic (
	...
	FOREIGN KEY (LogAlarmId) REFERENCES LogAlarms(LogAlarmId) ON UPDATE CASCADE ON DELETE CASCADE,
	FOREIGN KEY (SNSTopicId) REFERENCES SNSTopics(SNSTopicId) ON UPDATE CASCADE ON DELETE CASCADE,
...
CREATE TABLE Assigners (
	AssignerId INT NOT NULL AUTO_INCREMENT,
	UserId INT NOT NULL,
	LogAlarmSNSTopicId INT NOT NULL,
	PRIMARY KEY (AssignerId),
	FOREIGN KEY (UserId) REFERENCES Users(UserId) ON UPDATE CASCADE ON DELETE CASCADE,
	FOREIGN KEY (LogAlarmSNSTopicId) REFERENCES XRefLogAlarmSNSTopic(LogAlarmSNSTopicId) ON UPDATE CASCADE ON DELETE CASCADE,
	UNIQUE (UserId, LogAlarmSNSTopicId)
);
